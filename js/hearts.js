// ========================================
// CURSOR HEARTS & CLICK EFFECTS — Themed SVG
// ========================================
(function() {
    var lastHeartTime = 0;
    function getThemedCursorShape(size) {
        if (typeof currentTheme !== 'undefined' && currentTheme && typeof SVG !== 'undefined') {
            ...
            if (SVG[shapeName]) return SVG[shapeName](size, color, color2);
            return SVG.heart(size, color, color2);
        }
        return '<svg viewBox="0 0 100 100" width="' + size + '" height="' + size + '"><path d="M50 88C25 70 5 55 5 35 5 20 17 8 32 8c8 0 14 4 18 10 4-6 10-10 18-10 15 0 27 12 27 27 0 20-20 35-45 53z" fill="#FF4081"/></svg>';
    }
