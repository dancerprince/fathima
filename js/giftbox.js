...
function openGiftBox() {
    ...
    createGiftSparkles();
    var randomIndex;
    do { randomIndex = Math.floor(Math.random() * loveQuotes.length); } while (randomIndex === lastGiftQuoteIndex && loveQuotes.length > 1);
    ...
    setTimeout(function() {
        ...
        if (quoteText) quoteText.textContent = loveQuotes[randomIndex];
...
function createGiftSparkles() {
    ...
    for (var i = 0; i < 10; i++) {
        ...
        sparkle.style.left = '50%'; sparkle.style.top = '30%';
